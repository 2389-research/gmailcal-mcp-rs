use mcp_gmailcal::errors::{
    error_codes::{
        AUTHENTICATION_ERROR, CALENDAR_NOT_FOUND, CONFIG_ERROR, CONTACT_NOT_FOUND, DRAFT_NOT_FOUND,
        EVENT_FORMAT_ERROR, EVENT_NOT_FOUND, INTERNAL_ERROR, INVALID_REQUEST, MESSAGE_FORMAT_ERROR,
        MESSAGE_NOT_FOUND, NOT_FOUND_ERROR, RATE_LIMIT_ERROR,
    },
